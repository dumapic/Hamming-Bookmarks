...
public class CharUtils
{
	...
	{
		if (ch < CHAR_ARRAY.length) { return CHAR_ARRAY[ch]; }
	...
	{
		if (StringUtils.isEmpty(str)) { throw new IllegalArgumentException(
	...
	{
		if (isAsciiNumeric(ch) == false) { throw new IllegalArgumentException(
				"The character " + ch + " is not in the range '0' - '9'"); }
		return ch - 48;
	}
	...
	{
		if (ch < 128) { return CHAR_STRING_ARRAY[ch]; }
