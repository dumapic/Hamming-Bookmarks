 ...
 * </table>
 * <P>
 * NOTE: Modified for Android(TM) platform. by DUMAPIC
 * (http://twitter.com/#!/dumapick)
 *
 ...
 */
public class StrTokenizer implements ListIterator<Object>, Cloneable
{
	...
	{
		if (hasNext()) { return tokens[tokenPos++]; }
		return null;
	}
	...
	{
		if (hasPrevious()) { return tokens[--tokenPos]; }
		return null;
	}
	...
	private int readNextToken(char[] chars, int start, int len, StrBuilder workArea, List<String> tokens)
	{
		...
		if (quoteLen > 0) { return readWithQuotes(chars, start + quoteLen, len,
				workArea, tokens, start, quoteLen); }
